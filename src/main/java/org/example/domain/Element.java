...
public enum Element {
    ...
    /**
     * Returns an element object when given a string object
     * @param element   String that represents an element found in the periodic table
     * @return  Element object that corresponds to the string parameter
     */
